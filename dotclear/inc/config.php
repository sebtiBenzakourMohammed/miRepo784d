...
// Database user
define('DC_DBUSER','mymohammedtienda');

// Database password
define('DC_DBPASSWORD','Msb.93345900');

// Database name
define('DC_DBNAME','dotclear784d');
...
define('DC_MASTER_KEY','282b58a16d162b26bb38fa855f657613');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://www.mohammed.com.mialias.net/dotclear/dotclear/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','sebti.benzakour.mohammed@iescamas.es');
